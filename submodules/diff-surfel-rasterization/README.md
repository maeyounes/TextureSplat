...
This is the rasterization engine for the paper "TextureSplat: Per-Primitive Texture Mapping for Reflective Gaussian Splatting". If you use this code for your research, please cite our work.

<section class="section" id="BibTeX">
  <div class="container is-max-desktop content">
    <h2 class="title">BibTeX</h2>
    <pre><code>@article{younes2025texturesplat,
