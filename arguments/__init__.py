...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        # Eval-time opt-in: sample per-primitive textures via a hardware
        # cudaTextureObject atlas (tex2D) instead of the software bilinear
        # path. Only used in `render_surfel_textured`.
        self.use_hw_sampling = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.albedo_lr = 0.0075
        self.metallic_lr =  0.005
        self.roughness_lr =  0.005
        # The learning rate of the texture tangent-normal map in the texture stage.
        ...
        # Texture stage (4th stage): from texture_from_iter the baseline model is
        # transferred to a TexturedGaussianModel with per-primitive texture maps
        # of resolution texture_size x texture_size.
        self.texture_from_iter = 30000
        self.texture_size = 4
